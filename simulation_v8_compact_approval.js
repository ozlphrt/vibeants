...
class AntForagingSimulation {
    ...
    drawApprovalScreen() {
        ...
        if (this.approvalStep === 1) {
            this.ctx.fillText('Step 1: Nests placed on opposite sides.', this.width / 2, panelY + 60);
            this.ctx.fillText('Orange (Colony 1) and Green (Colony 2).', this.width / 2, panelY + 80);
            this.ctx.fillText('Click "Next Step" to place food sources.', this.width / 2, panelY + 100);
        } else if (this.approvalStep === 2) {
            this.ctx.fillText(`Step 2: Food Pair ${this.currentPair + 1}/4`, this.width / 2, panelY + 60);
            this.ctx.fillText('Red apple (Colony 1) and Green apple (Colony 2).', this.width / 2, panelY + 80);
            this.ctx.fillText('Check distances. Click "Approve" or "Reject".', this.width / 2, panelY + 100);
        } else if (this.approvalStep === 3) {
            this.ctx.fillText(`Step 3: Obstacles for Pair ${this.currentPair + 1}/4`, this.width / 2, panelY + 60);
            this.ctx.fillText('Gray obstacles between food and nests.', this.width / 2, panelY + 80);
            this.ctx.fillText('Click "Approve" to continue, or "Reject" to restart.', this.width / 2, panelY + 100);
        } else if (this.approvalStep === 4) {
            this.ctx.fillText('Complete! All strategic elements placed.', this.width / 2, panelY + 60);
            this.ctx.fillText('8 food sources and 15 obstacles total.', this.width / 2, panelY + 80);
            this.ctx.fillText('8 strategic + 7 random obstacles for challenge.', this.width / 2, panelY + 100);
        }
    ...
    nextApprovalStep() {
        if (this.approvalStep === 1) {
            ...
            if (this.currentPair < 4) {
                ...
                // All strategic pairs complete, add random obstacles
    ...
    placeRandomObstacles() {
        // Place remaining obstacles randomly (total should be 15)
        const remainingObstacles = this.obstacleCount - this.obstacles.length;
        ...
        console.log(`Placed ${remainingObstacles} random obstacles. Total obstacles: ${this.obstacles.length}`);
    }
